...
- APK: [totem-release-aug23-2026.apk](totem-release-aug23-2026.apk)
- User manual: [docs/Totem_User_Manual.pdf](docs/Totem_User_Manual.pdf)
- Build date: Aug23-2026
- Release date: August 23, 2026
- App version: 2026.08.23-guest
- Android package: `com.sleepy.totem.guest`
- Source commit: `2db5b07`
- SHA-256: `F5A3AA16BE93744CE5904C93E651536919EBF8CB4C20185C8D44DBA0FF5CEF94`

## APK Changelog

### 2026.08.23-guest

- Added built-in NTRIP and TCP stream profiles while preserving saved endpoint
  and processing settings.
- Improved NTRIP account validation, fresh-position GGA delivery, reconnect
  behavior, and correction-stream relay handling.
- Expanded RTCM3 observation and metadata decoding for broader caster and base
  station compatibility, including common legacy and MSM message variants.
- Added optional solution-type counts and a compact Phone/Totem ENU standard
  deviation comparison on the Map page.
- Improved map accuracy presentation and aligned the East, North, and Up STD
  table columns across changing values.
...
```powershell
adb install -r totem-release-aug23-2026.apk
```
...
- `totem-release-aug23-2026.apk`: installable Android release APK.
